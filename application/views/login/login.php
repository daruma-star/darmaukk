            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        ...
                        <a href="<?php echo base_url('c_masyarakat/registrasi'); ?>" class="signup-image-link">Create an account</a>
                    </div>
                    ...
                    <div class="signin-form">
                        ...
                        <form action="<?php echo base_url('c_masyarakat/login') ?>" method="POST" class="register-form" id="login-form">
